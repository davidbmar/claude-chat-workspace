...
| B-035 | Sidebar titles not retroactively stripped of markdown | B-032 strips markdown at write time only. Conversations saved before Sprint 15 still show raw **asterisks** in sidebar titles. Fix: apply stripMarkdown() at render time in the sidebar component. | low | Open |
