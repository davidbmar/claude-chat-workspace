# Claude Instructions — claude-chat-workspace
...
PROJECT_ROOT=/Users/dmar/src/claude-chat-workspace OUTPUT_DIR=<framework>/dist/projects/claude-chat-workspace/data ./scripts/build-sprint-data.sh
```
